...
- [docs.swift.org - A Swift Tour](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/guidedtour/)
  - [thebasics Optional - example entry](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/thebasics/#Optionals)
  - [closures - example entry](https://docs.swift.org/swift-book/documentation/the-swift-programming-language/closures)
...
- Use Terminal to clone [course wiki](https://github.com/molab-itp/content-2026-ima/wiki)
...
git clone https://github.com/molab-itp/content-2026-ima.wiki.git
...
- add a link to your Week02 folder on the
  - [wiki home page](https://github.com/molab-itp/content-2026-ima/wiki#week-02-homework)
